...
class Pattern(models.Model):
    ...
    hook_or_needle_size = models.DecimalField(
        max_digits=5, decimal_places=2, help_text="Enter size in millimeters."
    )
...
class Material(models.Model):
    ...
    pattern = models.ForeignKey(
        to=Pattern, on_delete=models.CASCADE, related_name="materials"
    )
    ...
    unit = models.CharField(
        max_length=20, choices=UnitChoices.choices, default=UnitChoices.NONE
    )
